...
import Preview from "@/components/comm/Preview"
const DynamicPreview = dynamic(() => import("@/components/comm/Preview"), {
	ssr: false,
})
const BlogCard = ({
	cardDesc,
			...
			<article className="w-full flex gap-4 flex-col">
				<div className="w-full flex gap-4 sm:flex-row  flex-col-reverse">
					<div className="w-full  flex flex-col gap-2 ">
						...
						<DynamicPreview
							className="line-clamp-4 	  text-base  m-0  text-[rgb(78,89,104)]"
							content={cardDesc}
						/>
					</div>
